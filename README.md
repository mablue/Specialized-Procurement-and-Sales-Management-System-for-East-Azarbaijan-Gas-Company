...
## درباره پروژه:
سیستم مدیریت خرید‌های داخلی امور‌ تدارکات و عملیات شرکت گاز استان آذربایجان شرقی، سیستمی متن باز و برپایه لایسنس MIT می باشد که با توجه به روال های اداری شرکت نفت ایران و فرم های خاص مربوطه، طراحی و توسعه یافته است.
...
<p>
    ...
    <img width="700px" src="screenshots/3.png">
